...
async def get_column_qdrant_repository():
    return ColumnQdrantRepository(qdrant_client_manager.qdrant_client)


async def get_metric_qdrant_repository():
    return MetricQdrantRepository(qdrant_client_manager.qdrant_client)

async def get_value_qdrant_repository():
    return ValueQdrantRepository(qdrant_client_manager.qdrant_client)
...
async def get_embedding_client():
    return embedding_client_manager.embedding_client
...
async def get_query_service(
        ...
        value_qdrant_repository: Annotated[ValueQdrantRepository, Depends(get_value_qdrant_repository)],
